...
export async function detectAeiou(
  ...
  try {
    ...
    const prompt = [
      ...
      '',
      'A = Activities: What is the person doing? (structured or unstructured?)',
      'E = Environments: What kind of place? How does it feel? (open, confined, bright, dim, noisy, calm?)',
      'I = Interactions: Is the person interacting with people or machines? Formal or informal?',
      'O = Objects: What devices, tools, or notable objects are visible?',
      'U = Users: Who else is present? How many people? Any names visible?',
      '',
