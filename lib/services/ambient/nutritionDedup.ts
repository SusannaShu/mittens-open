...
function buildDedupPrompt(
  ...
  return [
    ...
    '1. "skip" -- the EXACT SAME food/drink item that was already logged and has NOT changed.',
    '   Only skip if the specific item is identical (e.g., same untouched coffee mug).',
    '   IMPORTANT: If the item is DIFFERENT (e.g., oats cup vs coffee cup, bowl vs mug,',
    '   different food type), that is NOT a skip -- even if the setting/desk is the same.',
