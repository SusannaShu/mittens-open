...
#define IMU_INT1_PIN                                                           \
  GPIO_NUM_3 // D2 -- INT1: wake-up motion (deep sleep wake source)
#define IMU_INT2_PIN GPIO_NUM_4 // D3 -- INT2: button-press
...
#define AUDIO_DURATION_SEC                                                     \
  10 // max seconds (push-to-talk stops early on release)
#define AUDIO_BUFFER_BYTES                                                     \
  (AUDIO_SAMPLE_RATE * 2 * AUDIO_DURATION_SEC) // 320KB max
...
#define DATA_INFO_UUID                                                         \
  "6e400005-b5a3-f393-e0a9-e50e24dcca9e" // Phone reads: {type, jpegLen,
                                         // audioLen}
#define DATA_STREAM_UUID                                                       \
  "6e400006-b5a3-f393-e0a9-e50e24dcca9e" // Pendant notifies: binary chunks
#define DATA_ACK_UUID                                                          \
  "6e400007-b5a3-f393-e0a9-e50e24dcca9e" // Phone writes: flow control

#define BLE_CHUNK_SIZE                                                         \
  180 // Bytes per BLE notification (safe for iOS MTU of 185)
#define BLE_TRANSFER_TIMEOUT_MS 20000 // Max time to wait for phone to pull data
#define BLE_ADVERTISE_WAIT_MS                                                  \
  15000 // How long to advertise DATA_READY before sleeping
